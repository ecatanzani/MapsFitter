...

{
    ...
    TemplateFitBH(DAMPE_DataHisto_1D_I_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_I_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_Iso_LS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (NS) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (NS) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniNS_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniNS_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_AniNS_LS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (EW) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (EW) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniEW_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniEW_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_AniEW_LS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (FB) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (FB) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniFB_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniFB_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_AniFB_LS);
    
    std::cout << "\n\n -------------- > NS + EW linear combination \n\n";
    output_log_file << "\n\n -------------- > NS + EW linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_NS_EW_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_NS_EW_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_Mixed_NS_EW_LS);
    
    std::cout << "\n\n -------------- > NS + FB linear combination \n\n";
    output_log_file << "\n\n -------------- > NS + FB linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_NS_FB_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_NS_FB_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_Mixed_NS_FB_LS);
    
    std::cout << "\n\n -------------- > EW + FB linear combination \n\n";
    output_log_file << "\n\n -------------- > EW + FB linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_EW_FB_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_EW_FB_LS,DAMPE_Templates_1D_LS,res,DAMPE_hPull_Mixed_EW_FB_LS);
    
    std::cout << "\n\n -------------- > FullMixed linear combination \n\n";
    output_log_file << "\n\n -------------- > FullMixed linear combination \n\n";
    
    TemplateFitBH(DAMPE_FullMixedHisto_1D_LS,4,DAMPE_Templates_1D_LS,res,res_err,initialValues,false,false,false,true,output_log_file);
    ...
    TemplateFitBH(DAMPE_DataHisto_1D_I_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_I_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_Iso_HS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (NS) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (NS) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniNS_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniNS_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_AniNS_HS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (EW) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (EW) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniEW_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniEW_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_AniEW_HS);
    
    std::cout << "\n\n -------------- > Anisotropic Monopole (FB) \n\n";
    output_log_file << "\n\n -------------- > Anisotropic Monopole (FB) \n\n";
    
    TemplateFitBH(DAMPE_DataHisto_1D_AniFB_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_DataHisto_1D_AniFB_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_AniFB_HS);
    
    std::cout << "\n\n -------------- > NS + EW linear combination \n\n";
    output_log_file << "\n\n -------------- > NS + EW linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_NS_EW_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_NS_EW_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_Mixed_NS_EW_HS);
    
    std::cout << "\n\n -------------- > NS + FB linear combination \n\n";
    output_log_file << "\n\n -------------- > NS + FB linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_NS_FB_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_NS_FB_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_Mixed_NS_FB_HS);
    
    std::cout << "\n\n -------------- > EW + FB linear combination \n\n";
    output_log_file << "\n\n -------------- > EW + FB linear combination \n\n";
    
    TemplateFitBH(DAMPE_MixedHisto_1D_EW_FB_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
    getPull(DAMPE_MixedHisto_1D_EW_FB_HS,DAMPE_Templates_1D_HS,res,DAMPE_hPull_Mixed_EW_FB_HS);
    
    std::cout << "\n\n -------------- > FullMixed linear combination \n\n";
    output_log_file << "\n\n -------------- > FullMixed linear combination \n\n";
    
    TemplateFitBH(DAMPE_FullMixedHisto_1D_HS,4,DAMPE_Templates_1D_HS,res,res_err,initialValues,false,false,false,true,output_log_file);
