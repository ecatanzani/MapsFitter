...
void load_1D_histos(TH1D Templates_LS[],TH1D &DataHisto_I_LS,TH1D &DataHisto_NS_LS,TH1D &DataHisto_EW_LS,TH1D &DataHisto_FB_LS,TH1D &MixedDataHisto_NS_EW_LS,TH1D &MixedDataHisto_NS_FB_LS,TH1D &MixedDataHisto_EW_FB_LS,TH1D &FullMixedDataHisto_LS,TH1D Templates_HS[],TH1D &DataHisto_I_HS,TH1D &DataHisto_NS_HS,TH1D &DataHisto_EW_HS,TH1D &DataHisto_FB_HS,TH1D &MixedDataHisto_NS_EW_HS,TH1D &MixedDataHisto_NS_FB_HS,TH1D &MixedDataHisto_EW_FB_HS,TH1D &FullMixedDataHisto_HS,std::string template_path,std::string data_path,std::ofstream &log_file) {
    ...
    TH2toTH1_obj(tmpTemplates_LS[0],Template_Iso_LS);
    TH2toTH1_obj(tmpTemplates_LS[1],Template_AniNS_LS);
    TH2toTH1_obj(tmpTemplates_LS[2],Template_AniEW_LS);
    TH2toTH1_obj(tmpTemplates_LS[3],Template_AniFB_LS);
    
    TH2toTH1_obj(tmpTemplates_HS[0],Template_Iso_HS);
    TH2toTH1_obj(tmpTemplates_HS[1],Template_AniNS_HS);
    TH2toTH1_obj(tmpTemplates_HS[2],Template_AniEW_HS);
    TH2toTH1_obj(tmpTemplates_HS[3],Template_AniFB_HS);
    
    ///////////////////////// Converting Data Maps from TH2 to TH1
    
    TH2toTH1_obj(tmpDataHisto_I_LS,Data_Iso_LS);
    TH2toTH1_obj(tmpDataHisto_NS_LS,Data_AniNS_LS);
    TH2toTH1_obj(tmpDataHisto_EW_LS,Data_AniEW_LS);
    TH2toTH1_obj(tmpDataHisto_FB_LS,Data_AniFB_LS);
    TH2toTH1_obj(tmpMixedDataHisto_NS_EW_LS,MixedData_NS_EW_LS);
    TH2toTH1_obj(tmpMixedDataHisto_NS_FB_LS,MixedData_NS_FB_LS);
    TH2toTH1_obj(tmpMixedDataHisto_EW_FB_LS,MixedData_EW_FB_LS);
    TH2toTH1_obj(tmpFullMixedDataHisto_LS,FullMixedData_LS);
    
    TH2toTH1_obj(tmpDataHisto_I_HS,Data_Iso_HS);
    TH2toTH1_obj(tmpDataHisto_NS_HS,Data_AniNS_HS);
    TH2toTH1_obj(tmpDataHisto_EW_HS,Data_AniEW_HS);
    TH2toTH1_obj(tmpDataHisto_FB_HS,Data_AniFB_HS);
    TH2toTH1_obj(tmpMixedDataHisto_NS_EW_HS,MixedData_NS_EW_HS);
    TH2toTH1_obj(tmpMixedDataHisto_NS_FB_HS,MixedData_NS_FB_HS);
    TH2toTH1_obj(tmpMixedDataHisto_EW_FB_HS,MixedData_EW_FB_HS);
    TH2toTH1_obj(tmpFullMixedDataHisto_HS,FullMixedData_HS);
    ...
    TH2toTH1_obj(DataHisto_I_LS,Data_Iso_LS);
    TH2toTH1_obj(DataHisto_NS_LS,Data_AniNS_LS);
    TH2toTH1_obj(DataHisto_EW_LS,Data_AniEW_LS);
    TH2toTH1_obj(DataHisto_FB_LS,Data_AniFB_LS);
    TH2toTH1_obj(MixedDataHisto_NS_EW_LS,MixedData_NS_EW_LS);
    TH2toTH1_obj(MixedDataHisto_NS_FB_LS,MixedData_NS_FB_LS);
    TH2toTH1_obj(MixedDataHisto_EW_FB_LS,MixedData_EW_FB_LS);
    TH2toTH1_obj(FullMixedDataHisto_LS,FullMixedData_LS);
    
    TH2toTH1_obj(DataHisto_I_HS,Data_Iso_HS);
    TH2toTH1_obj(DataHisto_NS_HS,Data_AniNS_HS);
    TH2toTH1_obj(DataHisto_EW_HS,Data_AniEW_HS);
    TH2toTH1_obj(DataHisto_FB_HS,Data_AniFB_HS);
    TH2toTH1_obj(MixedDataHisto_NS_EW_HS,MixedData_NS_EW_HS);
    TH2toTH1_obj(MixedDataHisto_NS_FB_HS,MixedData_NS_FB_HS);
    TH2toTH1_obj(MixedDataHisto_EW_FB_HS,MixedData_EW_FB_HS);
    TH2toTH1_obj(FullMixedDataHisto_HS,FullMixedData_HS);
