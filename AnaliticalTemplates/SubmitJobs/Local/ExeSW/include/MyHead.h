...
const static bool all_sky_simulation = true;
const static bool DAMPE_simulation = false;
...
const static std::string DAMPE_Iso_scaled_Maps = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/AnaliticalTemplates/SubmitJobs/Local/ExeSW/assets/scalingSoftware/scaled_reference_Isotropic_histos.root";
const static std::string templates_path = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/AnaliticalTemplates/SubmitJobs/Local/ExeSW/assets/computeTemplates/results/AllSkyTemplates.root";
const static std::string DAMPE_templates_path = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/AnaliticalTemplates/SubmitJobs/Local/ExeSW/assets/computeTemplates/results/DAMPETemplates.root";
const static std::string seeds_path = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/AnaliticalTemplates/SubmitJobs/Local/ExeSW/assets/produceSeeds/seeds.txt";
