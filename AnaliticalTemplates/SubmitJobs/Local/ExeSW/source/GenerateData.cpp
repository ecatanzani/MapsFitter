...

{
    ...
    Data_Iso_LS->FillRandom(pTemplate_Data_Iso_LS,gRandom->Poisson(data_all_sky_LS_events));
    Data_AniNS_LS->FillRandom(pTemplate_Data_AniNS_LS,gRandom->Poisson(data_all_sky_LS_events));
    Data_AniEW_LS->FillRandom(pTemplate_Data_AniEW_LS,gRandom->Poisson(data_all_sky_LS_events));
    Data_AniFB_LS->FillRandom(pTemplate_Data_AniFB_LS,gRandom->Poisson(data_all_sky_LS_events));
    MixedData_NS_EW_LS->FillRandom(pTemplate_MixedData_NS_EW_LS,gRandom->Poisson(data_all_sky_LS_events));
    MixedData_NS_FB_LS->FillRandom(pTemplate_MixedData_NS_FB_LS,gRandom->Poisson(data_all_sky_LS_events));
    MixedData_EW_FB_LS->FillRandom(pTemplate_MixedData_EW_FB_LS,gRandom->Poisson(data_all_sky_LS_events));
    FullMixedData_LS->FillRandom(pTemplate_FullMixedData_LS,gRandom->Poisson(data_all_sky_LS_events));
...

{
    ...
    Data_Iso_HS->FillRandom(pTemplate_Data_Iso_HS,gRandom->Poisson(data_all_sky_HS_events));
    Data_AniNS_HS->FillRandom(pTemplate_Data_AniNS_HS,gRandom->Poisson(data_all_sky_HS_events));
    Data_AniEW_HS->FillRandom(pTemplate_Data_AniEW_HS,gRandom->Poisson(data_all_sky_HS_events));
    Data_AniFB_HS->FillRandom(pTemplate_Data_AniFB_HS,gRandom->Poisson(data_all_sky_HS_events));
    MixedData_NS_EW_HS->FillRandom(pTemplate_MixedData_NS_EW_HS,gRandom->Poisson(data_all_sky_HS_events));
    MixedData_NS_FB_HS->FillRandom(pTemplate_MixedData_NS_FB_HS,gRandom->Poisson(data_all_sky_HS_events));
    MixedData_EW_FB_HS->FillRandom(pTemplate_MixedData_EW_FB_HS,gRandom->Poisson(data_all_sky_HS_events));
    FullMixedData_HS->FillRandom(pTemplate_FullMixedData_HS,gRandom->Poisson(data_all_sky_HS_events));
