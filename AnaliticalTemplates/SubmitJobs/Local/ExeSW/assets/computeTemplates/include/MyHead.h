...
const static std::string path_location = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/AnaliticalTemplates/SubmitJobs/Local/ExeSW/assets/computeTemplates/logs/";
