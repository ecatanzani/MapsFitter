...

{
    ...
    DAMPE_Data_Iso_LS->FillRandom(pDAMPE_Template_Data_Iso_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_Data_AniNS_LS->FillRandom(pDAMPE_Template_Data_AniNS_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_Data_AniEW_LS->FillRandom(pDAMPE_Template_Data_AniEW_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_Data_AniFB_LS->FillRandom(pDAMPE_Template_Data_AniFB_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_MixedData_NS_EW_LS->FillRandom(pDAMPE_Template_MixedData_NS_EW_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_MixedData_NS_FB_LS->FillRandom(pDAMPE_Template_MixedData_NS_FB_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_MixedData_EW_FB_LS->FillRandom(pDAMPE_Template_MixedData_EW_FB_LS,gRandom->Poisson(data_all_sky_LS_events));
    DAMPE_FullMixedData_LS->FillRandom(pDAMPE_Template_FullMixedData_LS,gRandom->Poisson(data_all_sky_LS_events));
...

{
    ...
    DAMPE_Data_Iso_HS->FillRandom(pDAMPE_Template_Data_Iso_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_Data_AniNS_HS->FillRandom(pDAMPE_Template_Data_AniNS_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_Data_AniEW_HS->FillRandom(pDAMPE_Template_Data_AniEW_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_Data_AniFB_HS->FillRandom(pDAMPE_Template_Data_AniFB_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_MixedData_NS_EW_HS->FillRandom(pDAMPE_Template_MixedData_NS_EW_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_MixedData_NS_FB_HS->FillRandom(pDAMPE_Template_MixedData_NS_FB_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_MixedData_EW_FB_HS->FillRandom(pDAMPE_Template_MixedData_EW_FB_HS,gRandom->Poisson(data_all_sky_HS_events));
    DAMPE_FullMixedData_HS->FillRandom(pDAMPE_Template_FullMixedData_HS,gRandom->Poisson(data_all_sky_HS_events));
