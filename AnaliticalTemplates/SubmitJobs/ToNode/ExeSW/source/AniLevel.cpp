...
double compute_relative_ani_level(double covMatrix[][3],double parameters[],double par_err[],std::ofstream &log_file)
{
    for(int idx_par=0; idx_par < 3; ++idx_par)
    {
        parameters[idx_par] *= 1/TMath::Sqrt(4*TMath::Pi());
        par_err[idx_par] *= 1/TMath::Sqrt(4*TMath::Pi());
    }
        
    double level = TMath::Sqrt(TMath::Power(parameters[0],2) + TMath::Power(parameters[1],2) + TMath::Power(parameters[2],2));
    double delta_derivative[3];
    double var_delta = 0;
    
    delta_derivative[0] = parameters[0]/TMath::Sqrt(TMath::Power(parameters[0],2) + TMath::Power(parameters[1],2) + TMath::Power(parameters[2],2));
    delta_derivative[1] = parameters[1]/TMath::Sqrt(TMath::Power(parameters[0],2) + TMath::Power(parameters[1],2) + TMath::Power(parameters[2],2));
    delta_derivative[2] = parameters[2]/TMath::Sqrt(TMath::Power(parameters[0],2) + TMath::Power(parameters[1],2) + TMath::Power(parameters[2],2));
    
    for(Int_t idx1=0; idx1 < 3; ++idx1)
