...
void link_tree_branches(TChain &tree,fitResult &tmp_fit,std::string tree_dir_path);
...
void link_tree_branches(TChain &tree,fitResult &tmp_fit,std::string tree_dir_path)
{
    ...
    tree.SetBranchAddress("CMatrix_Iso_LS",tmp_fit.CMatrix_Iso_LS);
    ...
    tree.SetBranchAddress("entries_Iso_Map_LS",tmp_fit.entries_Iso_Map_LS);
    ...
    tree.SetBranchAddress("CMatrix_Iso_HS",tmp_fit.CMatrix_Iso_HS);
    ...
    tree.SetBranchAddress("entries_Iso_Map_HS",tmp_fit.entries_Iso_Map_HS);
