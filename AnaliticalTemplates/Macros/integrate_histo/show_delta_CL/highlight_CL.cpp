...
void highlight_CL(std::vector<TH1D*> &hdelta_68cloned,std::vector<TH1D*> &hdelta_95cloned,Double_t integrals_68[],Double_t integrals_95[]);
...
int main(int argc,char* argv[])
{
    ...
    std::vector<TH1D*> hdelta_cloned;
    std::vector<TH1D*> hdelta_68cloned;
    std::vector<TH1D*> hdelta_95cloned;
    
    hdelta.resize(4);
    hdelta_cloned.resize(4);
    hdelta_68cloned.resize(4);
    hdelta_95cloned.resize(4);
    ...
    hdelta_cloned[0] = (TH1D*) hdelta[0].Clone("delta_cloned_1");
    hdelta_cloned[1] = (TH1D*) hdelta[1].Clone("delta_cloned_3");
    hdelta_cloned[2] = (TH1D*) hdelta[2].Clone("delta_cloned_6");
    hdelta_cloned[3] = (TH1D*) hdelta[3].Clone("delta_cloned_10");
    
    hdelta_68cloned[0] = (TH1D*) hdelta[0].Clone("delta_68cloned_1");
    hdelta_68cloned[1] = (TH1D*) hdelta[1].Clone("delta_68cloned_3");
    hdelta_68cloned[2] = (TH1D*) hdelta[2].Clone("delta_68cloned_6");
    hdelta_68cloned[3] = (TH1D*) hdelta[3].Clone("delta_68cloned_10");
    
    hdelta_95cloned[0] = (TH1D*) hdelta[0].Clone("delta_95cloned_1");
    hdelta_95cloned[1] = (TH1D*) hdelta[1].Clone("delta_95cloned_3");
    hdelta_95cloned[2] = (TH1D*) hdelta[2].Clone("delta_95cloned_6");
    hdelta_95cloned[3] = (TH1D*) hdelta[3].Clone("delta_95cloned_10");
    ...
    highlight_CL(hdelta_68cloned,hdelta_95cloned,integrals_68,integrals_95);
    ...
    for(Int_t idx=0; idx<hdelta_cloned.size(); ++idx)
    {
        hdelta_cloned[idx]->Write();
        hdelta_68cloned[idx]->Write();
        hdelta_95cloned[idx]->Write();
    }
...
void get_delta_histos(std::string paths[],std::vector<TH1D> &hdelta)
{
    ...
    TH1D delta_16("delta_16","delta distribution (16000)",100,0,0.016);
    TH1D delta_32("delta_32","delta distribution (32000)",100,0,0.012);
    TH1D delta_64("delta_64","delta distribution (64000)",100,0,0.008);
    TH1D delta_110("delta_110","delta distribution (110000)",100,0,0.006);
...
void highlight_CL(std::vector<TH1D*> &hdelta_68cloned,std::vector<TH1D*> &hdelta_95cloned,Double_t integrals_68[],Double_t integrals_95[])
{
    for(Int_t idxd=0; idxd<hdelta_68cloned.size(); ++idxd)
    {
        hdelta_68cloned[idxd]->GetXaxis()->SetRangeUser(0,integrals_68[idxd]);
        hdelta_95cloned[idxd]->GetXaxis()->SetRangeUser(integrals_68[idxd],integrals_95[idxd]);
        hdelta_68cloned[idxd]->SetFillColor(38);
        hdelta_95cloned[idxd]->SetFillColor(46);
    }
}
