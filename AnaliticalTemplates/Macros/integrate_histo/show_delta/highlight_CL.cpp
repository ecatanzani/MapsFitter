...
void get_delta_histos(std::string paths[],std::vector<TH1D> &hdelta)
{
    ...
    TH1D delta_16("delta_16","delta distribution (16000)",100,0,0.2);
    TH1D delta_32("delta_32","delta distribution (32000)",100,0,0.14);
    TH1D delta_64("delta_64","delta distribution (64000)",100,0,0.1);
    TH1D delta_110("delta_110","delta distribution (110000)",100,0,0.07);
