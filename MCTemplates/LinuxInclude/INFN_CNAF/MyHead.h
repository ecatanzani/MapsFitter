...
const static std::string output_log = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/MCTemplates/logs/";
const static std::string output_root = "/storage/gpfs_data/dampe/users/ecatanzani/MyRepos/DAMPE/MapsFitting/MCTemplates/results/";
